...
// Main App Component
function App() {
  // For demo purposes, let's create a temporary demo mode
        ...
        <div className="min-h-screen bg-gray-50">
          <div className="ml-64">
            ...
            <div className="bg-white shadow-sm border-b border-gray-200 p-4">
              <div className="flex items-center justify-between">
                <h1 className="text-2xl font-bold text-gray-900">AutoBid Pro - Demo Dashboard</h1>
                <button 
            ...
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-8 m-4 rounded-lg">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-purple-100 text-lg">
                    Welcome to the AutoBid Pro reverse auction platform!
                  </p>
                  <div className="flex items-center space-x-6 mt-4">
                    <div className="flex items-center space-x-2">
                      <Users className="h-5 w-5" />
              ...
              <div className="bg-white rounded-lg shadow-md">
                <div className="p-6 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      <h2 className="text-xl font-bold text-gray-900">Recent Auctions</h2>
                      <p className="text-sm text-gray-600">Displaying 3 vehicles</p>
                    </div>
                    <div className="flex items-center space-x-2">
                      <select className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
                        <option>Ending Soon</option>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center justify-between mb-3">
                          <span className="text-blue-600 font-bold">$49,000</span>
                          <span className="text-sm text-gray-500">Starting: $45,000</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
                          <div className="bg-yellow-500 h-2 rounded-full" style={{ width: '60%' }}></div>
                        </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                      ...
                      <div className="p-4">
                        <h3 className="font-semibold text-gray-900 mb-2">BMW X5 M Competition</h3>
                        <p className="text-sm text-gray-600 mb-2">2023 • Dubai, UAE • 15,000 km</p>
                        <div className="flex items-center justify-between mb-3">
                          <span className="text-blue-600 font-bold">$87,500</span>
                          <span className="text-sm text-gray-500">Starting: $75,000</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
                          <div className="bg-red-500 h-2 rounded-full" style={{ width: '85%' }}></div>
                        </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                      ...
                      <div className="p-4">
                        <h3 className="font-semibold text-gray-900 mb-2">Audi A4 Quattro</h3>
                        <p className="text-sm text-gray-600 mb-2">2023 • Sharjah, UAE • 8,500 km</p>
                        <div className="flex items-center justify-between mb-3">
                          <span className="text-blue-600 font-bold">$60,000</span>
                          <span className="text-sm text-gray-500">Starting: $55,000</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
                          <div className="bg-yellow-500 h-2 rounded-full" style={{ width: '70%' }}></div>
                        </div>
          ...
          <div className="w-64 bg-white shadow-lg h-screen fixed left-0 top-0 z-10">
            ...
            {/* Navigation */}
            <nav className="p-4 space-y-2">
              <div className="flex items-center space-x-3 px-4 py-3 rounded-lg bg-blue-600 text-white">
                <Home className="h-5 w-5" />
                <span className="font-medium">Dashboard</span>
              </div>
              <div className="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-600">
